...
knitr::include_graphics("charts/all_mf_Ethiopia.pdf")
```
\vspace{3mm}
```{r out.width = "100%", out.height="120%", fig.align = "right", echo=FALSE, strip.white=TRUE}
knitr::include_graphics("charts/socsec_Ethiopia.pdf")
```
\vspace{3mm}
...
knitr::include_graphics("charts/efficiency_Ethiopia.pdf")
```
...
knitr::include_graphics("charts/drm_Ethiopia.pdf")
```
