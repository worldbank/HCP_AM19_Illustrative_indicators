...
`r rl[[31]]` & `r x[["crossgpshare_hd_diffmi"]]` & `r x[["crossgpshare_edu_diffmi"]]` & `r x[["crossgpshare_hnp_diffmi"]]` & `r x[["crossgpshare_spj_diffmi"]]` \\ \hline
 ...
 \multicolumn{5}{l}{unrated. c) DO and IP are on a scale of 1 to 6 where 1 is Highly Unsatisfactory } \\
 \multicolumn{5}{l}{and 6 is Highly Satisfactory. d) Data as of September 5, 2019.} \\
\end{tabular}
\end{table}
